...
//  Set image sizes
//============================================================================================
// Disable messy responsive image implemenetation
...
add_image_size('gallery-image-large', 1280, 960, true);      // full width (1-wide)
add_image_size('gallery-image-medium', 640, 480, true);     // half width (2-wide)
add_image_size('gallery-image-small', 430, 323, true);      // one-third width (3-wide)

// Custom sizes for pages and posts
add_image_size('work-thumbnail', 600, 450, true);
add_image_size('post-banner', 1280, 500, true);
...
function add_custom_image_sizes($sizes) {
  return array_merge($sizes, array(
    ...
    'work-thumbnail' => _('Work thumbnail'),
    'post-banner' => _('Post banner')
  ));
}
